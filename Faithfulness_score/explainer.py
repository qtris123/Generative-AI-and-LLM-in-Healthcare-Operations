...
class Explainer():
    ...
    def engineer_features(self):
        ...
        X_train, X_test, y_train, y_test = train_test_split( X2, y2, train_size = 0.7, random_state = 40) #random_state must be 40 for alignment 
        ...
        return rf_model2, X_test, continuous_after.columns.drop(['placement'])
